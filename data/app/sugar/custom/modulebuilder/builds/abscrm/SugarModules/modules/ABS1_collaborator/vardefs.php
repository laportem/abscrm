...
$dictionary['ABS1_collaborator'] = array(
    'table' => 'abs1_collaborator',
    'audited' => true,
...
VardefManager::createVardef('ABS1_collaborator','ABS1_collaborator', array('basic','team_security','assignable','taggable'));