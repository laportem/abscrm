...
$relationships = array (
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'abs1_identifications_contacts_c',
        'join_key_lhs' => 'abs1_identifications_contactscontacts_ida',
        'join_key_rhs' => 'abs1_identifications_contactsabs1_identifications_idb',
      ),
    ),
    'table' => 'abs1_identifications_contacts_c',
    'fields' => 
    array (
      'id' => 
      array (
      ...
      'abs1_identifications_contactscontacts_ida' => 
      array (
        'name' => 'abs1_identifications_contactscontacts_ida',
        'type' => 'id',
      ),
      'abs1_identifications_contactsabs1_identifications_idb' => 
      array (
        'name' => 'abs1_identifications_contactsabs1_identifications_idb',
        'type' => 'id',
      ),
    ),
    'indices' => 
    array (
      0 => 
      array (
        'name' => 'idx_abs1_identifications_contacts_pk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'idx_abs1_identifications_contacts_ida1_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_identifications_contactscontacts_ida',
          1 => 'deleted',
        ),
      ),
      2 => 
      array (
        'name' => 'idx_abs1_identifications_contacts_idb2_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_identifications_contactsabs1_identifications_idb',
          1 => 'deleted',
        ),
      ),
      3 => 
      array (
        'name' => 'abs1_identifications_contacts_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'abs1_identifications_contactsabs1_identifications_idb',
  ...
  'contacts_abs1_collaborators_1' => 
  array (
    'rhs_label' => 'Collaborators',
    'lhs_label' => 'Contacts',
    'rhs_subpanel' => 'default',
    'lhs_module' => 'Contacts',
    ...
    'is_custom' => false,
    'from_studio' => true,
    'relationship_name' => 'contacts_abs1_collaborators_1',
  ),
);