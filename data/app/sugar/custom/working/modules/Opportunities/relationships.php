...
$relationships = array (
  ...
  array (
    ...
    'join_key_rhs' => 'abs1_collaborators_opportunitiesabs1_collaborators_idb',
    'readonly' => true,
    'relationship_name' => 'abs1_collaborators_opportunities',
    'rhs_subpanel' => 'default',
    'lhs_subpanel' => NULL,
    'is_custom' => true,
    'deleted' => false,
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'lhs_table' => 'opportunities',
        'lhs_key' => 'id',
        'rhs_module' => 'ABS1_sponsors',
        'rhs_table' => 'abs1_sponsors',
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'abs1_sponsors_opportunities_c',
        'join_key_lhs' => 'abs1_sponsors_opportunitiesopportunities_ida',
        'join_key_rhs' => 'abs1_sponsors_opportunitiesabs1_sponsors_idb',
      ),
    ),
    'table' => 'abs1_sponsors_opportunities_c',
    'fields' => 
    array (
      'id' => 
      array (
      ...
      'abs1_sponsors_opportunitiesopportunities_ida' => 
      array (
        'name' => 'abs1_sponsors_opportunitiesopportunities_ida',
        'type' => 'id',
      ),
      'abs1_sponsors_opportunitiesabs1_sponsors_idb' => 
      array (
        'name' => 'abs1_sponsors_opportunitiesabs1_sponsors_idb',
        'type' => 'id',
      ),
    ),
    'indices' => 
    array (
      0 => 
      array (
        'name' => 'idx_abs1_sponsors_opportunities_pk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'idx_abs1_sponsors_opportunities_ida1_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_sponsors_opportunitiesopportunities_ida',
          1 => 'deleted',
        ),
      ),
      2 => 
      array (
        'name' => 'idx_abs1_sponsors_opportunities_idb2_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_sponsors_opportunitiesabs1_sponsors_idb',
          1 => 'deleted',
        ),
      ),
      3 => 
      array (
        'name' => 'abs1_sponsors_opportunities_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'abs1_sponsors_opportunitiesabs1_sponsors_idb',
    ...
    'join_key_rhs' => 'abs1_sponsors_opportunitiesabs1_sponsors_idb',
    'readonly' => true,
    'relationship_name' => 'abs1_sponsors_opportunities',
    'rhs_subpanel' => 'default',
    'lhs_subpanel' => NULL,
    'is_custom' => true,
    'deleted' => false,
  ...
  array (
    ...
    'join_key_rhs' => 'abs1_providers_opportunitiesabs1_providers_idb',
    'readonly' => true,
    'relationship_name' => 'abs1_providers_opportunities',
    'rhs_subpanel' => 'default',
    'lhs_subpanel' => NULL,
    'is_custom' => true,
    'deleted' => false,
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'lhs_table' => 'opportunities',
        'lhs_key' => 'id',
        'rhs_module' => 'ABS1_projectmembers',
        'rhs_table' => 'abs1_projectmembers',
        'rhs_key' => 'id',
        'relationship_type' => 'many-to-many',
        'join_table' => 'abs1_projectmembers_opportunities_c',
        'join_key_lhs' => 'abs1_projectmembers_opportunitiesopportunities_ida',
        'join_key_rhs' => 'abs1_projectmembers_opportunitiesabs1_projectmembers_idb',
      ),
    ),
    'table' => 'abs1_projectmembers_opportunities_c',
    'fields' => 
    array (
      'id' => 
      array (
      ...
      'abs1_projectmembers_opportunitiesopportunities_ida' => 
      array (
        'name' => 'abs1_projectmembers_opportunitiesopportunities_ida',
        'type' => 'id',
      ),
      'abs1_projectmembers_opportunitiesabs1_projectmembers_idb' => 
      array (
        'name' => 'abs1_projectmembers_opportunitiesabs1_projectmembers_idb',
        'type' => 'id',
      ),
    ),
    'indices' => 
    array (
      0 => 
      array (
        'name' => 'idx_abs1_projectmembers_opportunities_pk',
        'type' => 'primary',
        'fields' => 
        array (
          0 => 'id',
      ...
      1 => 
      array (
        'name' => 'idx_abs1_projectmembers_opportunities_ida1_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_projectmembers_opportunitiesopportunities_ida',
          1 => 'deleted',
        ),
      ),
      2 => 
      array (
        'name' => 'idx_abs1_projectmembers_opportunities_idb2_deleted',
        'type' => 'index',
        'fields' => 
        array (
          0 => 'abs1_projectmembers_opportunitiesabs1_projectmembers_idb',
          1 => 'deleted',
        ),
      ),
      3 => 
      array (
        'name' => 'abs1_projectmembers_opportunities_alt',
        'type' => 'alternate_key',
        'fields' => 
        array (
          0 => 'abs1_projectmembers_opportunitiesabs1_projectmembers_idb',
